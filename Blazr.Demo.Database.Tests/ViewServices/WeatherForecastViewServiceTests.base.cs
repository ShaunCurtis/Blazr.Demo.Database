...
namespace Blazr.Template.Tests.ViewServices
{
    ...
    {
        private ValueTask<List<DvoWeatherForecast>> GetWeatherForecastListAsync(int noOfRecords)
            => ValueTask.FromResult(WeatherForecastDataStore.CreateTestViewForecasts(noOfRecords));
