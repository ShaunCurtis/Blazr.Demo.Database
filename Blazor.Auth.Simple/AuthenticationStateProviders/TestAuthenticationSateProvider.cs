...
/// ============================================================
namespace Blazor.Auth.Simple.AuthenticationStateProviders
{
    public class TestAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        public override Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            {
                TestUserType.Admin => Task.FromResult(new AuthenticationState(Admin)),
                TestUserType.User => Task.FromResult(new AuthenticationState(User)),
                TestUserType.None => Task.FromResult(new AuthenticationState(Anonymous)),
                _ => Task.FromResult(new AuthenticationState(Visitor))
            };
            return task;
        }
